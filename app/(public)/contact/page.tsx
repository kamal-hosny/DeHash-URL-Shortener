...
export const metadata: Metadata = {
  title: "Contact Us & Customer Support | DeHash",
  description:
    "Have questions about DeHash URL shortener or need support? Contact our team for assistance, API access, custom integrations, or feedback.",
  alternates: {
    canonical: "/contact",
  },
  openGraph: {
    title: "Contact Us & Customer Support | DeHash",
    description:
      "Get in touch with the DeHash team. We are here to help and answer any question you might have about our link shortening and QR services.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Contact Us & Customer Support | DeHash",
      },
    ],
  },
};
...
const ContactPage = () => {
  const contactSchema = {
    ...
    "@type": "ContactPage",
    name: "Contact DeHash Support & Sales",
    description:
      "Contact page for DeHash URL shortener support, inquiries, and customer service.",
    url: `${siteConfig.url}/contact`,
    mainEntity: {
      "@type": "Organization",
      ...
      contactPoint: {
        "@type": "ContactPoint",
        telephone: "+1012 3456 789",
        contactType: "customer service",
        email: "dehash@gmail.com",
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 group cursor-pointer hover:translate-x-2 transition-transform">
                      ...
                      <div>
                        ...
                        <a href="tel:+10123456789" className="font-medium hover:underline">
                          +1012 3456 789
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 group cursor-pointer hover:translate-x-2 transition-transform">
                      ...
                      <div>
                        ...
                        <a href="mailto:dehash@gmail.com" className="font-medium hover:underline">
                          dehash@gmail.com
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="pt-6 border-t border-white/10">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        ...
                        aria-label="Twitter"
                        className="w-11 h-11 rounded-xl bg-white/10 backdrop-blur-sm hover:bg-white hover:text-primary flex items-center justify-center transition-all hover:scale-110 hover:shadow-lg"
                      >
