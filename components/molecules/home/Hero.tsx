...
export default function Hero() {
  ...
  return (
    <div className="relative pt-16">
      ...
      <div className="absolute top-20 left-20 text-blue-400/40 text-4xl animate-pulse">✦</div>
      <div className="absolute top-32 right-32 text-purple-400/40 text-2xl animate-pulse delay-500">✦</div>
      <div className="absolute bottom-40 left-40 text-blue-400/40 text-3xl animate-pulse delay-700">✦</div>
      <div className="absolute top-60 right-60 text-purple-400/40 text-xl animate-pulse delay-300">•</div>
      <div className="absolute top-1/2 left-1/4 text-blue-400/30 text-lg animate-pulse delay-1000">✦</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10">
        ...
        <div className="flex gap-2 sm:gap-3 mb-6 sm:mb-8 justify-center px-4">
          <button
            ...
            className={`flex items-center gap-1.5 sm:gap-2 px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base transition-all ${
              activeTab === "link"
...
<div className="bg-card/60 text-card-foreground backdrop-blur-2xl rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-10 lg:p-14 shadow-2xl border border-border/50 relative overflow-hidden mx-4 sm:mx-0">
  ...
  <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8 md:space-y-10">
    ...
    <div className="w-full max-w-xl space-y-4 sm:space-y-6 px-2">
      <label className="block space-y-2 sm:space-y-3">
        ...
        <input
          ...
          className="w-full px-4 sm:px-5 py-3 sm:py-4 border border-input bg-background/60 backdrop-blur-sm rounded-xl sm:rounded-2xl 
          text-foreground shadow-sm text-sm sm:text-base
          focus:border-primary focus:ring-2 sm:focus:ring-4 focus:ring-primary/25 
          transition-all outline-none"
        />
      </label>

      <button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-4 sm:py-5 px-6 sm:px-8 rounded-xl sm:rounded-2xl transition-all flex items-center justify-center gap-2 sm:gap-3 shadow-lg hover:shadow-xl hover:scale-[1.02] sm:hover:scale-[1.03] group text-sm sm:text-base">
